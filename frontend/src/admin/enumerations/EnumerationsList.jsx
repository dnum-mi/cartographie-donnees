    ...
    render() {
        return (
            <div className="EnumerationsList">
                ...
                <p>Afin d'éditer un filtre ou son libellé, il faut double-cliquer sur un des filtres, ou l'un des libellés. Une fois la valeur modifiée, il faut confirmer en pressant la touche <i>Entrer</i>.</p>
