...
export const massEditDataSource = (data_source_ids, edition_type, key, value, type) => axios.put(API_HOST + '/data-sources/mass-edition', {data_source_ids, edition_type, key, value: value, type: type});
